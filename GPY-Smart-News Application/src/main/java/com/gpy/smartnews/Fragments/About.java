package com.gpy.smartnews.Fragments;
...
import com.gpy.smartnews.MainActivity;
import com.gpy.smartnews.R;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.emailLayout:
                ...
                emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Feedback Of GPY Smart News App");
            ...
            case R.id.moreLayout:
                ...
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/developer?id=Shri+Tambaskar")));
                break;
        }
    }
